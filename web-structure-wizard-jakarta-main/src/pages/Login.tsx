      ...
      <Card className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <Button type="submit" className="w-full bg-[#09403A] hover:bg-[#07322E] text-white">
              Se connecter
            </Button>
            <div className="text-sm text-center text-gray-600">
              Pas encore de compte?{" "}
              <Link to="/inscription" className="text-[#09403A] font-medium hover:underline">
                S'inscrire
              </Link>
            </div>
          </CardFooter>
